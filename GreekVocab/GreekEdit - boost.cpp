...
void CGreekEdit::Sigmify()	{
	...
	boost::wregex toMatch(_T("(σ)([\\s]|$)"));	//normal sigma at end of word or string
	...
	for(int i = 0;i < iLineCount;++i)	{
		...
		szLine[iChars] = '\0';
		sLine = szLine;
		std::wstring sReplaced = boost::regex_replace(sLine,toMatch,_T("ς\\2"),boost::match_default | boost::format_sed);
